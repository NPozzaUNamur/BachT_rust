use super::bacht_store::BachTStoreTrait;
...
pub(crate) fn bacht_exec_all(blackboard: &mut dyn BachTStoreTrait, agent: Expr) -> bool {
    let is_executed;
...
mod tests {
    ...
    use super::*;
    use super::super::bacht_store::MockBachTStoreTrait;
    // Primitive tests
    #[test]
    fn the_simulator_should_be_able_to_execute_a_tell_primitive() {
        let mut mock_bb = MockBachTStoreTrait::new();
